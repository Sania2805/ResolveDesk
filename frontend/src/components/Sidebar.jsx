    ...
    <aside className="sidebar">
        ...
        <div className="sidebar-header">
          <div className="brand">
            <div className="brand-icon" style={{
              background: isAdmin ? 'linear-gradient(135deg, #0284c7 0%, #38bdf8 100%)' : 'linear-gradient(135deg, #059669 0%, #10b981 100%)'
            }}>
            ...
            <div>
              <span className="brand-title">ResolveAI</span>
              <span className="brand-tag" style={{
                color: isAdmin ? '#38bdf8' : '#34d399',
                background: isAdmin ? 'rgba(56, 189, 248, 0.1)' : 'rgba(16, 185, 129, 0.1)'
              }}>
      ...
      <div className="sidebar-footer">
        <div className="footer-badge">
          <div className="footer-badge-icon" style={{
          ...
          <div>
            ...
            <div className="footer-text-secondary">
              {currentUser ? currentUser.name : 'Gemini-powered'}
            </div>
          </div>
        </div>
      </div>
